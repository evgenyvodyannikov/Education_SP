...
You can use the **SPSiteDataQuery** class to execute a query against multiple lists in a site collection. This is useful in scenarios where you want to aggregate list data from multiple sources. 
